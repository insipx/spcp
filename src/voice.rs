...
pub struct Voice {
    ...
    pub buf: [i64; (Sizes::BRR_BUF_SIZE * 2) as usize],
    pub buf_pos: usize, // place in buffer where next samples will be decoded
    pub interp_pos: i64, // relative fractional position in sample (0x1000 = 1.0)
    ...
    pub env: i64, // current envelope level
    pub hidden_env: i64, // used by GAIN mode 7, obscure quirk
